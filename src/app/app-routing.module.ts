...
const routes: Routes = [
  ...
  {path:'dashbor/list-patients', component: ListPatientsComponent, canActivate:[authGuardian]},
  ...
  {path: 'delete-patient', component: DeletePatientComponent, canActivate:[authGuardian]}
];
